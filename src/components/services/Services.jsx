    ...
    <div className="bg-white">
      <header>
        <Popover className="relative bg-white">
          <div className="mx-auto flex  items-center justify-between p-6 md:justify-start md:space-x-10 lg:px-8">
                  ...
                  <>
                    <Popover.Button
                      className={classNames(
                        ...
                        'group inline-flex items-center rounded-md bg-white text-xl font-medium hover:text-gray-900 focus:outline-none '
                      )}
                    >
                      <span>Solutions</span>
                      <ChevronDownIcon
                        className={classNames(
                          open ? 'text-gray-600 rotate-180' : 'text-gray-600',
                          'ml-2 h-8 w-8 group-hover:text-gray-600'
                        )}
                        aria-hidden="true"
                      />
                    </Popover.Button>
                    ...
                    >
                      <Popover.Panel className="absolute z-10 -ml-4 mt-4 w-screen max-w-md transform lg:left-1/2 lg:ml-0 lg:max-w-2xl lg:-translate-x-1/2">
                        <div className="overflow-hidden rounded-lg shadow-lg ring-1 ring-black ring-opacity-5">
                          <div className="relative grid gap-6 backdrop-blur-md bg-transparent px-5 py-6 sm:gap-8 sm:p-8 lg:grid-cols-2">
                            {solutions.map((item) => (
                              <a
                                key={item.name}
                                href={item.href}
                                className="-m-3 flex items-start rounded-lg p-3 border border-transparent hover:border  hover:border-gray-200 "
                              >
      ...
      <main>
              ...
              <div className="relative py-16 px-6 sm:py-24 lg:py-32 lg:px-8">
                ...
                <div className="mx-auto mt-10 max-w-sm sm:flex sm:max-w-none sm:justify-center">
                  <div className="space-y-4 sm:mx-auto sm:inline-grid sm:grid-cols-2 sm:gap-5 sm:space-y-0">
                    ...
                    >
                      <span className='get-started-span  rounded-md'>Let's Start</span>
        ...
        <div className="bg-gray-100">
          <div className="mx-auto max-w-7xl py-16 px-6 lg:px-8">
            ...
            <div className="mt-6 grid grid-cols-2 gap-8 md:grid-cols-6 lg:grid-cols-5">
              <div className="col-span-1 flex justify-center md:col-span-2 lg:col-span-1 transition ease-in-out delay-150  hover:-translate-y-0 hover:scale-150  duration-300">
              ...
              <div className="col-span-1 flex justify-center md:col-span-2 md:col-start-2 lg:col-span-1 transition ease-in-out delay-50  hover:-translate-y-0 hover:scale-150  duration-150">
                <img
                  className="h-12"
              ...
              <div className="col-span-2 flex justify-center md:col-span-2 md:col-start-4 lg:col-span-1 transition ease-in-out delay-50  hover:-translate-y-0 hover:scale-150  duration-150">
                <img
                  className="h-12"
          ...
          <div className="mx-auto max-w-4xl py-16 px-6 sm:pt-20 sm:pb-24 lg:max-w-7xl lg:px-8 lg:pt-24">
            ...
            <div className="mt-12 grid grid-cols-1 gap-x-6 gap-y-12 sm:grid-cols-2 lg:mt-16 lg:grid-cols-4 lg:gap-x-8 lg:gap-y-16">
              {features.map((feature) => (
                <div key={feature.name} className='animate-none'>
                  <div>
                    <span className="flex h-12 w-12 items-center justify-center rounded-md bg-transparent border animate-wiggle">
        ...
        <div className="relative bg-gray-900 ">
          ...
          <div className="mx-auto max-w-4xl px-6 lg:max-w-7xl lg:px-8 xl:grid backdrop-blur-md xl:grid-flow-col-dense xl:grid-cols-2 xl:gap-x-8">
      ...
      <footer className="bg-gray-50 bg-gradient-to-r from-purple-600 to-indigo-800 " aria-labelledby="footer-heading">
          ...
          <div className="xl:grid xl:grid-cols-3 xl:gap-8">
            <div className="grid grid-cols-2 gap-8 xl:col-span-2">
              <div className="md:grid md:grid-cols-2 md:gap-8">
                <div>
                  <h3 className="text-xl font-medium font-mono text-white">Solutions</h3>
                  <ul role="list" className="mt-4 ">
                    {footerNavigation.solutions.map((item) => (
                      <li key={item.name}>
                        <a href={item.href} className="text-sm text-gray-300 hover:text-gray-900">
                          {item.name}
                        </a>
                      </li>
                    ))}
                ...
                <div className="mt-12 md:mt-0">
                  <h3 className="text-xl font-medium font-mono text-white">Support</h3>
                  <ul role="list" className="mt-4 ">
              ...
              <div className="md:grid md:grid-cols-2 md:gap-8">
                <div>
                  <h3 className="text-xl font-medium font-mono text-white">Company</h3>
                  <ul role="list" className="mt-4 ">
                ...
                <div className="mt-12 md:mt-0">
                  <h3 className="text-xl font-medium font-mono text-white">Legal</h3>
                  <ul role="list" className="mt-4 ">
            ...
            <div className="mt-12 xl:mt-0">
              <h3 className="text-xl font-medium font-mono text-white">Subscribe to our newsletter</h3>

      ...
      <div className="lg:grid lg:grid-cols-12 lg:gap-x-16">
            ...
            {days.map((day, dayIdx) => (
              <button
                ...
                className={classNames(
                  'py-1.5 hover:bg-gray-100 focus:z-10 transition ease-in-out delay-75 hover:-translate-y-0 hover:scale-125 duration-150',
              ...
              >
                <time
                  ...
                  className={classNames(
                    ...
                    day.isSelected && !day.isToday && 'bg-gray-900 animate-ping'
                  )}
                >
        ...
        <ol className="mt-4 divide-y divide-gray-100 text-sm leading-6 lg:col-span-7 xl:col-span-8">
          {meetings.map((meeting) => (
            <li key={meeting.id} className="relative flex space-x-6 py-6 xl:static ease-in-out delay-75 hover:translate-y-1 hover:scale-105 duration-150">

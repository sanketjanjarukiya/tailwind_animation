...
export default function Team() {
  return (
    <div className="bg-white">
      <div className="mx-auto max-w-full py-12 px-6 lg:px-8 lg:py-24">
        <div className="space-y-12">
          ...
          >
            {people.map((person) => (
              <li key={person.name} className='transition ease-in-out delay-50 hover:-translate-y-0 hover:scale-110 duration-150'>
